...
data = pd.read_csv(
    "https://raw.githubusercontent.com/cns-iu/hra-cell-type-populations-supporting-information/main/validations/umap/umap_datasets_as_percentage.csv")
data.head()
